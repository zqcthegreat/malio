                    ...
                    <ul class="steps">
                      <li>
                        <div class="row">
                          <div class="left-text col-xs-12 col-md-6 col-lg-6">
                            ...
                            <p>下载 v2rayNG 客户端。</p>
                            <a href="https://www.lolxiu.vip/woc/v2rayNG.apk" class="btn btn-icon icon-left btn-primary btn-app btn-lg btn-round" target="blank"><i class="fas fa-download"></i> 下载客户端</a>
                          </div>
                          <div class="right-pic col-xs-12 col-md-6 col-lg-6">
                            <div class="tutorial-pic hide-on-mobie">
                              <img style="border:1px solid #f0f0f0" src="/theme/malio/img/tutorial/android-v2rayng-1.jpg">
                            </div>
                          </div>
                        </div>
                      </li>
                        ...
                        <div class="row">
                          ...
                          <div class="right-pic col-xs-12 col-md-6 col-lg-6">
                            <div class="tutorial-pic">
                              <img src="/theme/malio/img/tutorial/android-v2rayng-2.jpg">
                            </div>
                          </div>
                        </div>
                      </li>
                      <li>
                        ...
                        <div class="row">
                          ...
                          <div class="right-pic col-xs-12 col-md-6 col-lg-6">
                            <div class="tutorial-pic">
                              <img style="border:1px solid #f0f0f0" src="/theme/malio/img/tutorial/android-v2rayng-3.jpg">
                            </div>
                          </div>
                        </div>
                      </li>
                      <li>
                        ...
                        <div class="row">
                          ...
                          <div class="right-pic col-xs-12 col-md-6 col-lg-6">
                            <div class="tutorial-pic">
                              <img style="border:1px solid #f0f0f0" src="/theme/malio/img/tutorial/android-v2rayng-4.jpg">
                            </div>
                          </div>
                        </div>
                      </li>
                      <li>
                        ...
                        <div class="row">
                          ...
                          <div class="right-pic col-xs-12 col-md-6 col-lg-6">
                            <div class="tutorial-pic">
                              <img style="border:1px solid #f0f0f0" src="/theme/malio/img/tutorial/android-v2rayng-5.jpg">
                            </div>
                          </div>
                        </div>
                      </li>
