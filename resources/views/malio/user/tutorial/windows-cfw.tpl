                      ...
                      <li>
                        <div class="row">
                          <div class="left-text col-xs-12 col-md-6 col-lg-6">
                            ...
                            <p>也可在<a href="https://github.com/Dreamacro/clash/releases/">Github</a>下载。
								下载后解压运行Clash for Windows.exe即可。
							</p>
                            <a href="https://www.lolxiu.vip/woc/Clash-Windows.zip" class="btn btn-icon icon-left btn-primary btn-app btn-lg btn-round" target="blank"><i class="fas fa-download"></i> 下载客户端</a>
                          </div>
                      ...
                      <li>
                        ...
                        <div class="row">
                          <div class="left-text col-xs-12 col-md-6 col-lg-6">
                            ...
                            <p>在Clash侧边栏的Proxies里选择要用的节点，在General里打开 System Proxy 即可启用。</p>
							<p>注意如果在打开 System Proxy 时强制退出Clash或强制关机/重启，会导致电脑断网，这时重新打开Clash后正确关闭即可。</p>
                          </div>
                          <div class="right-pic col-xs-12 col-md-6 col-lg-6">
                            <div class="tutorial-pic">
                      ...
                      <div class="row mt-2 mb-2">
                        <div class="col-sm-6 col-xs-12 col-md-6 col-lg-6" id="manual-import">
                          ...
                          <p class="mb-4 font-13">
                            <a href="##" class="copy-text" data-clipboard-text="{$subInfo['clash']}{if $malio_config['enable_sub_extend'] == true}&extend=1{/if}"><b>点此复制 Clash 托管配置链接</b></a>，打开客户端的侧边栏的 Profiles，粘贴托管配置链接到左下角，点击 Direct Mode。
                          </p>
                        </div>
