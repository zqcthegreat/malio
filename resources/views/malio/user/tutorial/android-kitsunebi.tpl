                    ...
                    <ul class="steps">
                      <li>
                        <div class="row">
                          <div class="left-text col-xs-12 col-md-6 col-lg-6">
                            ...
                            <a href="https://sspaneldiag860.blob.core.windows.net/woc/Kitsunebi.apk" class="btn btn-icon icon-left btn-primary btn-app btn-lg btn-round" target="blank"><i class="fas fa-download"></i> 下载客户端</a>
                          </div>
                          <div class="right-pic col-xs-12 col-md-6 col-lg-6">
                            <div class="tutorial-pic hide-on-mobie">
                              <img style="border:1px solid #f0f0f0" src="/theme/malio/img/tutorial/android-kitsunebi-1.png">
                            </div>
                          </div>
                        </div>
                      </li>
                        ...
                        <div class="row">
                          ...
                          <div class="right-pic col-xs-12 col-md-6 col-lg-6">
                            <div class="tutorial-pic">
                              <img src="/theme/malio/img/tutorial/android-kitsunebi-2.jpg">
                            </div>
                          </div>
                        </div>
                      </li>
                      <li>
                        ...
                        <div class="row">
                          <div class="left-text col-xs-12 col-md-6 col-lg-6">
                            ...
                            <a href="##" class="btn btn-icon icon-left btn-primary btn-app copy-text btn-lg btn-round" data-clipboard-text="https://sspaneldiag860.blob.core.windows.net/woc/Kitsunebi_Basic.conf"><i class="malio-kitsunebi"></i> 复制远程规则集链接</a>
                          </div>
                          <div class="right-pic col-xs-12 col-md-6 col-lg-6">
                            <div class="tutorial-pic">
                              <img style="border:1px solid #f0f0f0" src="/theme/malio/img/tutorial/android-kitsunebi-3.jpg">
                            </div>
                          </div>
                        </div>
                      </li>
                      <li>
                        ...
                        <div class="row">
                          ...
                          <div class="right-pic col-xs-12 col-md-6 col-lg-6">
                            <div class="tutorial-pic">
                              <img style="border:1px solid #f0f0f0" src="/theme/malio/img/tutorial/android-kitsunebi-4.jpg">
                            </div>
                          </div>
                        </div>
                      </li>
