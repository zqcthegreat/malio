                    ...
                    <ul class="steps">
                      <li>
                        <div class="row">
                          <div class="left-text col-xs-12 col-md-6 col-lg-6">
                            ...
                            <a href="https://www.lolxiu.vip/woc/Clash-for-Android.apk" class="btn btn-icon icon-left btn-primary btn-app btn-lg btn-round" target="blank"><i class="fas fa-download"></i> 下载客户端</a>
                          </div>
                          <div class="right-pic col-xs-12 col-md-6 col-lg-6">
                            <div class="tutorial-pic hide-on-mobie">
                              <img style="border:1px solid #f0f0f0" src="/theme/malio/img/tutorial/android-clash-1.png">
                            </div>
                          </div>
                        </div>
                      </li>
                        ...
                        <div class="row">
                          ...
                          <div class="right-pic col-xs-12 col-md-6 col-lg-6">
                            <div class="tutorial-pic">
                              <img src="/theme/malio/img/tutorial/android-clash-2.png">
                            </div>
                          </div>
                        </div>
                      </li>
                      <li>
                        ...
                        <div class="row">
                          ...
                          <div class="right-pic col-xs-12 col-md-6 col-lg-6">
                            <div class="tutorial-pic">
                              <img style="border:1px solid #f0f0f0" src="/theme/malio/img/tutorial/android-clash-3.png">
                            </div>
                          </div>
                        </div>
                      </li>
