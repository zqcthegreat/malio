      ...
      <div class="row">
        <div class="col-md-5">
          ...
          <div class="pr-lg-5">
            ...
            <p>&copy;2018-{date("Y")} WocCloud.com. All rights reserved.</p>
        ...
        <div class="col-md-7">
          <div class="row">
            ...
            <div class="col-md-4">
              ...
              <ul>
                <li><a href="/user" data-i18n="dashboard">联系我们</a></li>
                <li><a href="https://down.woccloud.org/" data-i18n="dashboard">下载和使用</a></li>
                <li><a href="https://t.me/woccloud" data-i18n="dashboard">加入 Telegram 群组</a></li>
              </ul>
            </div>
          </div>
        </div>
