                        ...
                        <div class="card">
                            <div class="card-main">
                                <div class="card-inner">
                                    ...
                                    <script src="https://cdn.jsdelivr.net/gh/SuicidalCat/canvasjs.js@v2.3.1/canvasjs.min.js"></script>
                                    <script>
                        ...
                        <div class="card">
                            <div class="card-main">
                                <div class="card-inner">
                                    ...
                                    <script src="https://cdn.jsdelivr.net/gh/YihanH/canvasjs.js@v2.2/canvasjs.min.js"></script>
