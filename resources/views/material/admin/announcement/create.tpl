                    ...
                    <div class="card-main">
                        <div class="card-inner">
                            <div class="form-group form-group-label">
                                ...
                                <link rel="stylesheet"
                                      href="/cdn.jsdelivr.net/npm/editor.md@1.5.0/css/editormd.min.css"/>
                                <div id="editormd">
...
<script>
    (() => {
        editor = editormd("editormd", {
            path: "/cdn.jsdelivr.net/npm/editor.md@1.5.0/lib/", // Autoload modules mode, codemirror, marked... dependents libs path
            height: 720,
