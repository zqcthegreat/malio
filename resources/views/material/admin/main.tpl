...
<head>
    ...
    <link href="/cdn.jsdelivr.net/npm/material-design-lite@1.1.0/dist/material.min.css" rel="stylesheet">
    <link href="/cdn.jsdelivr.net/gh/DataTables/DataTables@1.10.19/media/css/dataTables.material.min.css"
          rel="stylesheet">

    <!-- js -->
    <script src="/cdn.jsdelivr.net/npm/jquery@3.2.1"></script>
    <!-- favicon -->
    <!-- ... -->
    <style>
        body {
